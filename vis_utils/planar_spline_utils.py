...
def plot_2d_wall(ax, w, grid=False, locater=1, alpha=1,
    ...
    ax.plot(walls1[0, 0], walls1[0, 1], color=wall_color, linewidth=5, alpha=alpha)
    ax.plot(walls2[0, 0], walls2[0, 1], color=wall_color, linewidth=5, alpha=alpha)
    ax.plot(walls3[0, 0], walls3[0, 1], color=wall_color, linewidth=5, alpha=alpha)
    ax.plot(walls4[0, 0], walls4[0, 1], color=wall_color, linewidth=5, alpha=alpha)
